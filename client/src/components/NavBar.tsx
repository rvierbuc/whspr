    ...
    <>
      ...
      <Navbar key={expand} expand={expand} className="navbar">
        <Container fluid>
          ...
          /></Navbar.Brand>
          <Navbar.Toggle onClick={() => { setIsOpen(() => !isOpen); }} aria-controls={`offcanvasNavbar-expand-${expand}`} style={{ color: '#e1e1e5', borderColor: '#e1e1e5', borderWidth: 'medium', margin:'10px' }}>
